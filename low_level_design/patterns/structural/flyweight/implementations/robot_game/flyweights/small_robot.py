...
class SmallRobot(RobotInterface):
    ...
    def __init__(self, robot_type: str, model: str, color: str) -> None:
    ...
    def display(self, context: dict)-> None:
        ...
        x = context["x"]
        y = context["y"]
        print(f"[SmallRobot] Position: ({x}, {y}) | Shared: Type={self.__robot_type}, Model={self.__model}, Color={self.__color}")